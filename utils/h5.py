...
def save_h5_and_csv(output_h5, output_csv, data):
    ...
    for row in data["label"]:
        # start_frame, end_frame, action_id_seq, action_en_seq, action_cn_seq, caption = row
        caption = row
        csv_row = {
            # "start_frame": start_frame,
            # "end_frame": end_frame,
            # "action_id_sequence": str(action_id_seq),  # 转换为字符串
            # "action_en_sequence": str(action_en_seq),
            # "action_cn_sequence": str(action_cn_seq),
            "id": cnt,
            "caption": caption
        }
